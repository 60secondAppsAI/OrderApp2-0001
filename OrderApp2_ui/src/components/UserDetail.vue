  ...
  <div class="user-detail-page">
    ...
    <main class="detail-content">
      ...
      <div v-else-if="error" class="error-state">
        ...
        <h3 class="error-title">Failed to Load User</h3>
      ...
      <!-- User Details -->
      <div v-else-if="userData" class="user-details">
        <div class="user-header-section">
          <div class="user-icon-large">{{ getUserIcon(userData) }}</div>
          <div class="user-header-info">
            <h1 class="user-title">{{ userData.name || 'Unknown User' }}</h1>
            <p class="user-subtitle">User ID: {{ userData.userId }}</p>
          </div>
        </div>
            ...
            <div class="tab-content">
                ...
                <div class="details-section">
                  ...
                  <div class="info-grid">
                    ...
                    <div class="info-item">
                      ...
                      <span class="info-value">{{ userData.userId || 'N/A' }}</span>
                    </div>
                    <div class="info-item">
                    ...
                    <div class="info-item">
                      <span class="info-label">EmailAddress</span>
                      <span class="info-value">{{ userData.emailAddress || 'N/A' }}</span>
                    </div>
              ...
              <div v-else-if="activeTab === 'Activity'" class="tab-panel">
                <div class="empty-tab-state">
                  ...
                  <h3>Activity Log</h3>
                  <p>User activity and history will be available here.</p>
                </div>
              </div>
            </div>
          </div>
