          ...
          <div class="user-info">
            ...
            <div class="user-metadata">
              ...
              <div class="metadata-item">
                ...
                <span class="metadata-value">{{ user.userName || 'N/A' }}</span>
              </div>
              <div class="metadata-item">
                <span class="metadata-label">EmailAddress:</span>
                <span class="metadata-value">{{ user.emailAddress || 'N/A' }}</span>
              </div>
        ...
        <table class="users-table">
          <thead>
            <tr>
              ...
              <th @click="handleSort('emailAddress')" class="sortable-header">
                EmailAddress {{ getSortIcon('emailAddress') }}
              </th>
          ...
          <tbody>
            <tr v-for="user in filteredUsers" :key="user.userId" class="user-row">
                ...
                <div class="$field.name.camel-info-table">
                  <span class="$field.name.camel-name-table">{{ user.userName }}</span>
                </div>
              </td>
                              <td class="$field.name.camel-cell">
                <div class="$field.name.camel-info-table">
                  <span class="$field.name.camel-name-table">{{ user.emailAddress }}</span>
                </div>
              </td>
