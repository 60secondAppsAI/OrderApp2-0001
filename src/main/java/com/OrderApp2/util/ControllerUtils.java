...
import com.OrderApp2.dto.ColumnDTO;
import com.OrderApp2.dto.common.FilterDTO;
import com.OrderApp2.dto.common.SortDTO;
...
public class ControllerUtils {
    ...
    public static Specification andIfNecessary(Specification spec, Date fieldValue, String fieldName) {
   		if (fieldValue != null) {
	        spec = spec.and((root, query, cb) -> cb.equal(root.get(fieldName), fieldValue));
	    }
   		return spec;
	...
	public static String generateRandomFilename(Integer length) {
